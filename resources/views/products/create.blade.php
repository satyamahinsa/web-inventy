    ...
    <div class="container mx-auto my-5 px-4">
        ...
        <div class="border border-gray-300 rounded-lg p-6 bg-white dark:bg-stone-600 mb-10">
            ...
            <form id="add-product-form" action="{{ route('products.store') }}" method="POST"
                ...
                @csrf
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-gray-800 dark:text-white">Nama
                        Produk</label>
                    <input type="text" name="name" id="name"
                        class="bg-white dark:bg-gray-500 text-gray-800 dark:text-white border dark:border-white rounded p-2 w-full"
                        required>
                </div>
                <div class="mb-4">
                    <label for="description"
                        class="block text-sm font-medium text-gray-800 dark:text-white">Deskripsi</label>
                    <textarea name="description" id="description"
                        class="bg-white dark:bg-gray-500 text-gray-800 dark:text-white border dark:border-white rounded p-2 w-full"></textarea>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="category_id"
                        class="block text-sm font-medium text-gray-800 dark:text-white">Kategori</label>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="border border-gray-300 text-gray-800 dark:text-white px-4 py-2">Rp.
